...
SetOS2Value("TypoAscent",            ${plemoljp35_ascent})
SetOS2Value("TypoDescent",          -${plemoljp35_descent})
...
SetOS2Value("TypoAscent",            ${plemoljp_ascent})
SetOS2Value("TypoDescent",          -${plemoljp_descent})
SetOS2Value("TypoLineGap",           0)
